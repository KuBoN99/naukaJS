...
document.getElementById("ex1").innerText += ex1;
document.getElementById("ex2").innerText += ex2;
document.getElementById("ex3").innerText += ex3;
document.getElementById("ex4").innerText += ex4;
document.getElementById("ex5").innerText += ex5;
document.getElementById("ex6").innerText += ex6;
document.getElementById("ex7").innerText += ex7;
document.getElementById("ex8").innerText += ex8;
